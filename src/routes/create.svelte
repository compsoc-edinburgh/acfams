<script>
    ...
    const submit = async () => {
        ...
        const r = await fetch(
            "https://child-slack-injest.compsoc.workers.dev",
            {
                method: "POST",
...
<svelte:head>
    ...
    <meta
        property="og:image"
        content="https://family.comp-soc.com/social.png" />
...
<main class="overflow-x-hidden">
    <div class="grid grid-cols-1">
        <section
            class="prose sm:prose-md md:prose-lg p-4 pt-16 max-w-2xl mx-auto 
           w-full lg:ml-auto">
            <h2 class="text-center">Deploy a new app</h2>
            <p>
                So you want to run a CompSoc service? Wonderful! You'll need to
                be part of the
                <a
                    href="https://github.com/orgs/compsoc-edinburgh/teams/sigweb">SigWeb</a>
                team on GitHub for this to work, and will need to have added
                your SSH keys to GitHub. Keys are synced at most every 30
                minutes, so you may need to wait that long after being added to
                the team. If you're not part of the team, but would
                <em>like</em>
                to be, ping an email over to
                <a href="mailto:techsec@comp-soc.com">techsec@comp-soc.com</a>
                and we'll get back to you as soon as we can.
            </p>
            <p>
                This is where students in older years ‘adopt’ freshers, and it’s
                a great way of helping the community, meeting new people, and
                having a good time together! We’re keeping it simple for now,
                with students in year 2 or above as the parents, and freshers as
                the children.
            </p>
            <p>
                We’ve had an amazing number of aspiring academic parents sign up
                so far, but now it’s your turn to sign up and complete your
                academic family.
            </p>

            <p>
                To sign up as an AcFam child all you need to do is fill out this
                form by the
                <strong>27th of September<strong />, so you've got plenty of
                    time!
                </strong>
            </p>
            <p>
                If you would like to ask any questions or need help with the
                form please email
                <a href="mailto:hello@comp-soc.com">hello@comp-soc.com</a>.
            </p>
        </section>
        <section
            ...
            <form class="w-full" name="parent">
              ...
              justify-center items-center mb-6 border-white cursor-pointer {cls} relative"
                ...
                <div class="w-full px-3 mb-6">
                    <label
                        class="block text-gray-700 text-lg mb-2"
                        for="student-number">
                ...
                resize-none h-32"
                    ...
                    <p class="text-gray-600 text-xs mt-2">
                        This will help us match you with parents, and it'll be
                        send to your future parents to help them get to know you
                    </p>
                </div>
                <div class="w-full px-3 mb-6">
                    <label class="block text-gray-700 text-lg mb-2">
                        With the COVID-19 pandemic, we know that many students
                        are studying virtually this year. So we can support you
                        with this, what types of events would you be willing to
                        attend or organise?
                    </label>
                    <RadioGroup
                        name="needs-match"
                    ...
                    <p class="text-gray-600 text-xs mt-2">
                        Don't worry, this isn't a final commitment &mdash; if
                        your circumstances change just let us know
                    </p>
                </div>
                <div class="prose px-3">
                    <h3>Your data</h3>
                    <p>
                        We'll store your data for the duration of the academic
                        families program this year
                    </p>
                    <h4>Your name, email, picture, and student number</h4>
                    <ul>
                        <li>
                            We'll use these to verify your CompSoc membership
                            and contact you about academic families
                        </li>
                        <li>
                            ...
                            to your academic parents once matched, so they can
                            contact you
                        </li>
                        <li>
                            We won't use your details to send marketing emails,
                            or any other emails unrelated to academic families
                        </li>
                    </ul>
                    <h4>
                        Your year of study, degree program and other information
                        you've provided us
                    </h4>
                    <ul>
                        <li>
                            We'll use this information to help us match you with
                            academic parents
                        </li>
                        <li>
                            Your
                            ...
                            and
                            <strong>bio</strong>
                            will also be provided to your future academic
                            parents to help them get to know you
                        </li>
                    </ul>
                    <h4>Your rights</h4>
                    Under the GDPR, you have certain rights with regards to your
                    data (See
                    <a href="https://gdpr.eu/tag/chapter-3/">Rights of the Data
                        Subject</a>
                    for a full list). Some important ones are the right to:
                    <ul>
                        <li><strong>request a copy of your data</strong></li>
                        <li>
                            <strong>correct any of your data that's innacurate</strong>
                        </li>
                        <li>
                            <strong>request deletion of your data</strong>
                            (although that will prevent you participating in
                            academic families this year)
                        </li>
                    </ul>
                    <p>
                        Please contact
                        <a
                            ...
                            class="text-primary">techsec@comp-soc.com</a>
                        with any queries
                    </p>
                </div>
